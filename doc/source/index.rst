...
It is composed of an assembler (``dgasm``), a binary file "inspector" (``dginspect``) and a simulator
(``dgsim``) that can be used together to develop and test code and also assist in "keying" it in, to .
